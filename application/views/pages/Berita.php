...
<!--                            <ol class="carousel-indicators">
                            ...
                            <div class="carousel-inner z-depth-1-half" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    <img class="d-block w-100" src="<?php echo base_url();?>foto_berita/medium_<?php echo $news_item['gambar']; ?>"
                                        alt="First slide">
                                </div>
                                <!--/First slide-->
                                <!--Second slide-->
...
<!--                        <p>Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id
                        ...
                        <a class="btn btn-primary btn-md" target='_blank' href='<?php echo base_url();?>news/view/<?php echo $news_item['id_berita']; ?>'>Read more</a>
